// Lab1_task2_nios_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Lab1_task2_nios_mm_interconnect_0 (
		...
		input  wire [14:0] nios2_PD_instruction_master_address,        //          nios2_PD_instruction_master.address
	...
	wire   [2:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> nios2_PD_data_master_agent:rp_channel
	...
	wire   [2:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> nios2_PD_instruction_master_agent:rp_channel
	...
	wire         cmd_mux_src_valid;                                                              // cmd_mux:src_valid -> onchip_mem_s1_agent:cp_valid
	wire  [89:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> onchip_mem_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                              // onchip_mem_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [2:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> onchip_mem_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                      // cmd_mux:src_startofpacket -> onchip_mem_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                        // cmd_mux:src_endofpacket -> onchip_mem_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_001_src_valid;                                                          // cmd_mux_001:src_valid -> pio_LED_s1_agent:cp_valid
	wire  [89:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> pio_LED_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                          // pio_LED_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> pio_LED_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                  // cmd_mux_001:src_startofpacket -> pio_LED_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                    // cmd_mux_001:src_endofpacket -> pio_LED_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_002_src_valid;                                                          // cmd_mux_002:src_valid -> pio_SW_s1_agent:cp_valid
	wire  [89:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> pio_SW_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                          // pio_SW_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> pio_SW_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                  // cmd_mux_002:src_startofpacket -> pio_SW_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                    // cmd_mux_002:src_endofpacket -> pio_SW_s1_agent:cp_endofpacket
	...
	wire         onchip_mem_s1_agent_rp_valid;                                                   // onchip_mem_s1_agent:rp_valid -> router_002:sink_valid
	wire  [89:0] onchip_mem_s1_agent_rp_data;                                                    // onchip_mem_s1_agent:rp_data -> router_002:sink_data
	wire         onchip_mem_s1_agent_rp_ready;                                                   // router_002:sink_ready -> onchip_mem_s1_agent:rp_ready
	wire         onchip_mem_s1_agent_rp_startofpacket;                                           // onchip_mem_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         onchip_mem_s1_agent_rp_endofpacket;                                             // onchip_mem_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         pio_led_s1_agent_rp_valid;                                                      // pio_LED_s1_agent:rp_valid -> router_003:sink_valid
	wire  [89:0] pio_led_s1_agent_rp_data;                                                       // pio_LED_s1_agent:rp_data -> router_003:sink_data
	wire         pio_led_s1_agent_rp_ready;                                                      // router_003:sink_ready -> pio_LED_s1_agent:rp_ready
	wire         pio_led_s1_agent_rp_startofpacket;                                              // pio_LED_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         pio_led_s1_agent_rp_endofpacket;                                                // pio_LED_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         pio_sw_s1_agent_rp_valid;                                                       // pio_SW_s1_agent:rp_valid -> router_004:sink_valid
	wire  [89:0] pio_sw_s1_agent_rp_data;                                                        // pio_SW_s1_agent:rp_data -> router_004:sink_data
	wire         pio_sw_s1_agent_rp_ready;                                                       // router_004:sink_ready -> pio_SW_s1_agent:rp_ready
	wire         pio_sw_s1_agent_rp_startofpacket;                                               // pio_SW_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         pio_sw_s1_agent_rp_endofpacket;                                                 // pio_SW_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         onchip_mem_s1_agent_rdata_fifo_src_valid;                                       // onchip_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] onchip_mem_s1_agent_rdata_fifo_src_data;                                        // onchip_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         onchip_mem_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter:in_0_ready -> onchip_mem_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                  // avalon_st_adapter:out_0_valid -> onchip_mem_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                   // avalon_st_adapter:out_0_data -> onchip_mem_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                  // onchip_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                  // avalon_st_adapter:out_0_error -> onchip_mem_s1_agent:rdata_fifo_sink_error
	...
	wire         pio_sw_s1_agent_rdata_fifo_src_valid;                                           // pio_SW_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] pio_sw_s1_agent_rdata_fifo_src_data;                                            // pio_SW_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         pio_sw_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_002:in_0_ready -> pio_SW_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                              // avalon_st_adapter_002:out_0_valid -> pio_SW_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                               // avalon_st_adapter_002:out_0_data -> pio_SW_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                              // pio_SW_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                              // avalon_st_adapter_002:out_0_error -> pio_SW_s1_agent:rdata_fifo_sink_error
	...
	Lab1_task2_nios_mm_interconnect_0_router router (
	...
	Lab1_task2_nios_mm_interconnect_0_router_001 router_001 (
	...
	Lab1_task2_nios_mm_interconnect_0_router_002 router_002 (
	...
	Lab1_task2_nios_mm_interconnect_0_router_003 router_003 (
	...
	Lab1_task2_nios_mm_interconnect_0_router_003 router_004 (
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                //       clk.clk
		.reset               (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                                //       clk.clk
		.reset               (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                                //       clk.clk
		.reset               (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                //       clk.clk
		.reset               (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                //       clk.clk
		.reset               (nios2_PD_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab1_task2_nios_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
