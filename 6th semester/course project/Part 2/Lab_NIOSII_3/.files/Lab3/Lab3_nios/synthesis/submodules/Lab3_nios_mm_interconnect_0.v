...
`timescale 1 ps / 1 ps
module Lab3_nios_mm_interconnect_0 (
	...
	wire   [4:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_qsys_data_master_agent:rp_channel
	...
	wire   [4:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_qsys_instruction_master_agent:rp_channel
	...
	wire   [4:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> nios2_qsys_debug_mem_slave_agent:cp_channel
	...
	wire   [4:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [15:0] buttons_s1_agent_m0_address;                                                      // buttons_s1_agent:m0_address -> buttons_s1_translator:uav_address
	...
	wire         cmd_mux_003_src_valid;                                                            // cmd_mux_003:src_valid -> buttons_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> buttons_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // buttons_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> buttons_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                    // cmd_mux_003:src_startofpacket -> buttons_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                      // cmd_mux_003:src_endofpacket -> buttons_s1_agent:cp_endofpacket
	...
	wire  [91:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire         buttons_s1_agent_rp_valid;                                                        // buttons_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] buttons_s1_agent_rp_data;                                                         // buttons_s1_agent:rp_data -> router_005:sink_data
	wire         buttons_s1_agent_rp_ready;                                                        // router_005:sink_ready -> buttons_s1_agent:rp_ready
	wire         buttons_s1_agent_rp_startofpacket;                                                // buttons_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         buttons_s1_agent_rp_endofpacket;                                                  // buttons_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [91:0] led_s1_agent_rp_data;                                                             // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire         buttons_s1_agent_rdata_fifo_src_valid;                                            // buttons_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] buttons_s1_agent_rdata_fifo_src_data;                                             // buttons_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         buttons_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_003:in_0_ready -> buttons_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                // avalon_st_adapter_003:out_0_valid -> buttons_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                 // avalon_st_adapter_003:out_0_data -> buttons_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                // buttons_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                // avalon_st_adapter_003:out_0_error -> buttons_s1_agent:rdata_fifo_sink_error
	...
	Lab3_nios_mm_interconnect_0_router router (
	...
	Lab3_nios_mm_interconnect_0_router_001 router_001 (
	...
	Lab3_nios_mm_interconnect_0_router_002 router_002 (
	...
	Lab3_nios_mm_interconnect_0_router_003 router_003 (
	...
	Lab3_nios_mm_interconnect_0_router_003 router_004 (
	...
	Lab3_nios_mm_interconnect_0_router_002 router_005 (
	...
	Lab3_nios_mm_interconnect_0_router_002 router_006 (
	...
	Lab3_nios_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab3_nios_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
